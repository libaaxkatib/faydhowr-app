...
return new class extends Migration
{
     ...
     * with the Sprint 28 quotation workflow permissions (API Design §18.10).
     */
    ...
    {
        return [
            AdminPermission::QuotationsView,
            AdminPermission::QuotationsReview,
            AdminPermission::QuotationsIssue,
            AdminPermission::QuotationsManage,
        ];
    }
};
