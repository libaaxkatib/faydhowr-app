...
class StoreOrderReportController extends Controller
{
    public function store(
        ...
        try {
            $result = $generateReport->handle($admin, ReportType::StoreOrders, $filters, $request->reportFormat(), $request->cursorPagination());
