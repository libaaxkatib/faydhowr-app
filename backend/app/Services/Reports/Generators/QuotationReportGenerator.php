...
class QuotationReportGenerator implements ReportGeneratorInterface
{
    public function __construct(private QuotationReportRepository $repository) {}
    ...
    public function generate(NormalizedReportFilters $filters, ?ReportCursorPagination $pagination = null): array
    {
        ...
        return [
            'report_type' => ReportType::Quotations->value,
