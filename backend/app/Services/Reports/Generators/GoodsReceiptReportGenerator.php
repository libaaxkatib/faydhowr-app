...
class GoodsReceiptReportGenerator implements ReportGeneratorInterface
{
    public function __construct(private GoodsReceiptReportRepository $repository) {}
    ...
    public function generate(NormalizedReportFilters $filters, ?ReportCursorPagination $pagination = null): array
    {
        ...
        return [
            'report_type' => ReportType::GoodsReceipts->value,
