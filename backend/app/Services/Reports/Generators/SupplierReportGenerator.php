...
class SupplierReportGenerator implements ReportGeneratorInterface
{
    public function __construct(private SupplierReportRepository $repository) {}
    ...
    public function generate(NormalizedReportFilters $filters, ?ReportCursorPagination $pagination = null): array
    {
        ...
        return [
            'report_type' => ReportType::Suppliers->value,
