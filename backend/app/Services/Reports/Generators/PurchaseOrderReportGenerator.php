...
class PurchaseOrderReportGenerator implements ReportGeneratorInterface
{
    public function __construct(private PurchaseOrderReportRepository $repository) {}
    ...
    public function generate(NormalizedReportFilters $filters, ?ReportCursorPagination $pagination = null): array
    {
        ...
        return [
            'report_type' => ReportType::PurchaseOrders->value,
