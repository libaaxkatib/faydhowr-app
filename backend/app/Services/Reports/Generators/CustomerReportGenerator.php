...
class CustomerReportGenerator implements ReportGeneratorInterface
{
    public function __construct(private CustomerReportRepository $repository) {}
    ...
    public function generate(NormalizedReportFilters $filters, ?ReportCursorPagination $pagination = null): array
    {
        ...
        return [
            'report_type' => ReportType::Customers->value,
